...
const Product = sequelize.define('Product', {
	...
	sex: DataTypes.TEXT,
	quantity_stock: { type: DataTypes.INTEGER, defaultValue: 0 },
	import_price: { type: DataTypes.INTEGER, defaultValue: 0 },
	price: { type: DataTypes.INTEGER, defaultValue: 0 },
	suppiler_id: { type: DataTypes.INTEGER, defaultValue: null },
