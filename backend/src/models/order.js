...
const Order = sequelize.define('Order', {
    ...
    customer_id: { type: DataTypes.INTEGER, defaultValue: null },
    voucher_id: { type: DataTypes.INTEGER, defaultValue: null },
	...
	total_product_value: { type: DataTypes.INTEGER, allowNull: false },
	voucher_value: { type: DataTypes.INTEGER, defaultValue: 0 },
